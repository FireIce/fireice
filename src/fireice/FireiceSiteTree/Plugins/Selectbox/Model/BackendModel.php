...
namespace fireice\FireiceSiteTree\Plugins\Selectbox\Model;

class BackendModel extends \fireice\FireiceSiteTree\Plugins\BasicPlugin\Model\BackendModel
{
    ...
    public function getData($sitetree_id, $module, $module_id, $module_type, $rows=false)
    {
        ...
        foreach ($result as $key => $val) {
            ...
            if ($module_type === \fireice\FireiceSiteTree\Modules\BasicBundle\Model\BackendModel::TYPE_LIST) $return[$key]['row_id'] = $val['row_id'];
