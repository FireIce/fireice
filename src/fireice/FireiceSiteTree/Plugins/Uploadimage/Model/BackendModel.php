...
namespace fireice\FireiceSiteTree\Plugins\Uploadimage\Model;
...
class BackendModel extends \fireice\FireiceSiteTree\Plugins\BasicPlugin\Model\BackendModel
{
    ...
    { 
        $plugin_entity_class = 'fireice\\FireiceSiteTree\\Plugins\\'.ucfirst($this->controller->getValue('type')).'\\Entity\\plugin'.$this->controller->getValue('type');
