...
namespace fireice\FireiceSiteTree\Plugins\BasicPlugin\Model;
...
class BackendModel
{
    ...
    {
        $plugin_entity = 'fireice\\FireiceSiteTree\\Plugins\\'.ucfirst($this->controller->getValue('type')).'\\Entity\\plugin'.$this->controller->getValue('type');
