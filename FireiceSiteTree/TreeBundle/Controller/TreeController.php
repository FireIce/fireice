...
namespace fireice\FireiceSiteTree\TreeBundle\Controller;
                   
use Symfony\Bundle\FrameworkBundle\Controller\Controller;
use Symfony\Component\HttpFoundation\RedirectResponse;
use Symfony\Component\HttpFoundation\Response;
 
use fireice\FireiceSiteTree\TreeBundle\Model\TreeModel;                                                                                 
...
{                                                                             
    ...
    {        
        ...
        $tree_model = new TreeModel($em, $sess);         
        
        $messages = $tree_model->getNewMessages($this->get('security.context'));        
                
        $response = $this->render( 'TreeBundle:Tree:backoffice.html.twig', array('messages' => $messages) );
    ...
    {           
        ...
        {        	
            $module = $em->getRepository('DialogsBundle:modules')->findOneBy(array(
                'idd'    => $this->get('request')->get('module_type'),
                'final'  => 'Y',
                'status' => 'active'
            ));
            ...
            if ($module->getType() == 'sitetree_node')
                $this->get('cache')->updateSiteTreeStructure();
        ...
        elseif ($this->get('request')->get('act') == 'get_row')
        {
            ...
            $fields = $module_act->getRowData($this->get('request')->get('id'),$this->get('request')->get('type'), $this->get('request')->get('row_id'));                       
        }        
