...
{                                                                             
    ...
    {      
        ...
        {            
            ...
            {                
                if ($i == 0)
                    $childs = $frontend_model->getChilds(1);
                else                    
                    $childs = $frontend_model->getChilds($path[$i-1]);    
                ...
                {   
                    ...
                    if ($module_act->checkEndOf($ostatok))
                        return $this->showPage($path[$i-1], $ostatok);                    
    ...
    {  
        ...
        } else { $modules_html['main'] = 'Ошибка!<br>Вы не имеете доступа к этой странице!'; }
